            ...
            <div className="container text-center">
                ...
                <div className="row mt-3">
                    <div className="col justify-content-center">
                        ...
                        <p className="mt-2 text-secondary">Start scoring and explore the Vulnerability Dashboard.</p>
                        <div className="row mt-3">
                            <Link to="/vuln_dashboard">
                                <button type="button" className="btn btn-outline-primary fw-semibold v">Start scoring</button>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col justify-content-center">
                        <h3 className="fw-bold">MAP ASSETS TO ATTACKS</h3>
                        <p className="mt-2 text-secondary">Here you can add your assets and map them to attack patterns!</p>
                        <div className="row mt-3">
                            <Link to="/mapping_assets">
                                <button type="button" className="btn btn-outline-primary fw-semibold v">Map your Assets</button>
                            </Link>
                        </div>
                    </div>
                </div>
