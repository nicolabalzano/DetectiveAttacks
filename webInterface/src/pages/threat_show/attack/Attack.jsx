...
const Attack = () => {
    ...
    const otherImportantInfo = ['Detection suggestions', 'Mitigations', 'Procedure examples', 'Campaigns that exploit this attack pattern', 'Targeted assets', 'Targeted personal assets',
