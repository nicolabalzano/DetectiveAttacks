...
from src.model.interfaceToMitre.mitreData.mitreAttackToCVE.MitreAttackToCVEData import MitreAttackToCVEData
from src.model.interfaceToMitre.mitreData.utils.Path import default_path, ATTACK_TO_CVE, ENTERPRISE_ATTACK, \
